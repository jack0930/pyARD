...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Single.setGeometry(QtCore.QRect(210, 230, 421, 51))
        self.Single.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
        self.Single.setObjectName("Single")
        self.Bulk = QtWidgets.QPushButton(self.centralwidget)
        self.Bulk.setGeometry(QtCore.QRect(210, 290, 421, 51))
        self.Bulk.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
        self.Bulk.setObjectName("Bulk")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Single.setText(_translate("MainWindow", "Single File"))
        self.Bulk.setText(_translate("MainWindow", "Bulk select"))
