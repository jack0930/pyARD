...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Ca.setGeometry(QtCore.QRect(210, 230, 421, 51))
        self.Ca.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
        self.Ca.setObjectName("Ca")
        self.K = QtWidgets.QPushButton(self.centralwidget)
        self.K.setGeometry(QtCore.QRect(210, 290, 421, 51))
        self.K.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
