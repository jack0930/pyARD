...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TT.setGeometry(QtCore.QRect(210, 230, 421, 51))
        self.TT.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
        self.TT.setObjectName("TT")
        self.isor = QtWidgets.QPushButton(self.centralwidget)
        self.isor.setGeometry(QtCore.QRect(210, 290, 421, 51))
        self.isor.setStyleSheet("font: 20pt \".AppleSystemUIFont\";")
        self.isor.setObjectName("isor")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TT.setText(_translate("MainWindow", "T"))
        self.isor.setText(_translate("MainWindow", "ISOr"))
